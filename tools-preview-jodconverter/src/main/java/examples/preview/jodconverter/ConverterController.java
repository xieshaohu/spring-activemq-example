...
public class ConverterController {
    ...
    @Value("${browser.type}")
    private String browserType = "inline";
    ...
    private ResponseEntity<Object> convert(
        ...
        try (ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
            ...
            String targetMediaType = targetFormat.getMediaType();
            MediaType parseMediaType = MediaType.parseMediaType(targetMediaType);
            LOGGER.debug("targetMediaType: {}, parseMediaType: {}", targetFormat, parseMediaType);
            headers.setContentType(parseMediaType);
            headers.add(
                    "Content-Disposition",
                    browserType + "; filename="
